...
import com.gitlab.hillel.dnepr.java.ee.oleksii.zinkevych.js_rest_repository.service.CountryService;
...
@Controller
public class CountryController extends AbstractEntityController<Integer> {

    @Override
    public void init() {
        ServletContext servletContext = getServletContext();
        WebApplicationContext context = WebApplicationContextUtils.getWebApplicationContext(servletContext);
        super.entityService = context.getBean(CountryService.class);
