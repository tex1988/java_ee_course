...
import com.gitlab.hillel.dnepr.java.ee.oleksii.zinkevych.js_rest_repository.service.UserService;
...
@Controller
public class UserController extends AbstractEntityController<String> {

    @Override
    public void init() {
        ServletContext servletContext = getServletContext();
        WebApplicationContext context = WebApplicationContextUtils.getWebApplicationContext(servletContext);
        super.entityService = context.getBean(UserService.class);
